...
const RegisterPage = () => {
  ...
  return (
    <div className="auth-shell relative flex min-h-screen items-center justify-center overflow-hidden bg-brand-gradient px-4 py-12">
      <div className="absolute right-[-8rem] top-[-10rem] h-[28rem] w-[28rem] rounded-full bg-brand-500/30 blur-[100px]" />
      <div className="absolute left-[-8rem] bottom-[-10rem] h-[24rem] w-[24rem] rounded-full bg-accent-500/25 blur-[100px]" />

      <form onSubmit={onSubmit} className="glass-card z-10 w-full max-w-lg space-y-5 p-8 shadow-card sm:p-10">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-slate-300">Create your account and start tracking attendance.</p>
        </div>
